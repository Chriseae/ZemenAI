...
const CheckoutPage: React.FC<CheckoutPageProps> = ({ plan, billing, onBack }) => {
  ...
  // Free: $0
  // Pro: $12/mo (monthly) or $9.96/mo (yearly)
  // Enterprise: $60/mo (monthly) or $49.8/mo (yearly)

  let pricePerMonth = 0;
  let totalDue = 0;

  if (plan === 'pro') {
    pricePerMonth = billing === 'monthly' ? 12 : 9.96;
  } else if (plan === 'enterprise') {
    pricePerMonth = billing === 'monthly' ? 60 : 49.8;
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-gray-600 mb-8 max-w-md">
          Thank you for your subscription to the {plan === 'pro' ? 'Pro' : 'Enterprise'} plan. Your account has been upgraded.
        </p>
        <button
          onClick={onBack}
